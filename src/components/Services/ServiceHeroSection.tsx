          ...
          <div className="relative z-10 px-6 sm:px-12 lg:px-20 py-12 sm:py-16 lg:py-20 text-center">
            ...
            <div className="space-y-6 lg:space-y-8 max-w-4xl mx-auto">
              <p className="text-base sm:text-lg lg:text-xl text-white leading-relaxed">
                At Saoirse, we deliver IT solutions designed to meet the
                evolving needs of businesses and individuals in today’s
                digital-first world.
              </p>

              <p className="text-base sm:text-lg lg:text-xl text-white leading-relaxed">
                From application development and digital infrastructure to smart
                investment platforms and referral systems, our services are
                powered by advanced technology, seamless scalability, and
                dedicated support.
              </p>

              <p className="text-base sm:text-lg lg:text-xl text-white leading-relaxed">
                We don’t just provide solutions — we create tailored strategies
                that help our partners accelerate growth, optimize operations,
